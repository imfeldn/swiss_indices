...
### help function
source("helpfuns.R")
source("helpfuns_swissplateau.R")
source("helpfuns_temp_quantiles.R")
...
if(merge){
  ...
  saveRDS(sw_full, file = "data/05_swissplateau/swissplateau_daily_hom_1756-2021.rds")
} else{
  sw_full <- readRDS("data/05_swissplateau/swissplateau_daily_hom_1756-2021.rds")
}
...
saveRDS(index_list, file = paste0("data/01_climate_indices/swissplateau_stations_indices_",Sys.Date(),".rds"))
